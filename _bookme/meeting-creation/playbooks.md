...
The playbook approach runs for **portal bookings** whose portal uses the **Playbook** strategy. Otherwise the [CRM Configuration]({{ site.baseurl }}/bookme/meeting-creation/crm-configuration/) approach handles the booking.
