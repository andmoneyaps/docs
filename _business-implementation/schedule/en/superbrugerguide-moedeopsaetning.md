...
| Display name (Name in meeting booking) | The name the customer sees when booking. From Schedule Salesforce package 1.29.0, the advisor also sees this name in the Salesforce booking flow. If the field is empty, the internal name is shown. |
