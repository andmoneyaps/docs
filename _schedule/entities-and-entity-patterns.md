...
nav_order: 7.5
redirect_from:
  - /bookme/entities-and-entity-patterns/
---
...
This page explains the model conceptually. For how entity patterns are used inside playbooks, see the [block type reference]({{ site.baseurl }}/schedule/playbooks/introduction-to-playbooks/#entitypatternread) in the playbook introduction.
...
![Entity definitions list showing configured CRM objects with their types, field counts, and pattern usage]({{ site.baseurl }}/assets/images/schedule/entities/entity-definitions-list.png)
...
![Entity definition edit form showing field mappings — each field has a Name, Mapped name, Type, and Required/Read-only flags]({{ site.baseurl }}/assets/images/schedule/entities/entity-definition-edit.png)
...
![Entity patterns list showing configured patterns with their part counts and playbook usage]({{ site.baseurl }}/assets/images/schedule/entities/entity-patterns-list.png)
...
![Entity pattern edit form showing the "Portal meeting" pattern with three entity parts]({{ site.baseurl }}/assets/images/schedule/entities/entity-pattern-edit.png)

### What it contains

| Property | What it means |
|----------|--------------|
| **Name** | A descriptive label (e.g., "Schedule Meeting", "Customer Account Lookup") |
...
![Dependency graph visualization showing three entity nodes connected by requirement edges]({{ site.baseurl }}/assets/images/schedule/entities/entity-pattern-graph.png)
...
{: .hint }
When a playbook is imported into a new environment, entity patterns referenced by playbook blocks can be automatically provisioned if the export includes resource definitions. See [Import and Export]({{ site.baseurl }}/schedule/playbooks/playbooks-user-guide/#import-and-export) in the playbook user guide.

---

## Related Documentation

- [Introduction to Playbooks — Block Types]({{ site.baseurl }}/schedule/playbooks/introduction-to-playbooks/#block-types) — how EntityPatternRead, Create, Update, and Filter blocks use entity patterns
- [Playbooks Integrations — Entity Pattern Integration]({{ site.baseurl }}/schedule/playbooks/playbooks-integration-guide/#entity-pattern-integration) — integration details for CRM blocks
