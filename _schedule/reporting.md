...
The Schedule Reporting dashboard provides managers and administrators with a comprehensive view of meeting booking activity across their organization. It is available in the Management UI under **Schedule > Reporting**.
...
<img src="{{ site.baseurl }}/assets/images/schedule/reporting/reporting-overview.png" width="1000" alt="Reporting dashboard overview showing summary card, statistics table, and filter controls"/>
...
2. In the left sidebar, expand **Schedule**
3. Click **Reporting**
...
<img src="{{ site.baseurl }}/assets/images/schedule/reporting/reporting-filters.png" width="400" alt="Period and customer type filter dropdowns"/>
...
<img src="{{ site.baseurl }}/assets/images/schedule/reporting/reporting-summary-card.png" width="800" alt="Summary card showing total meetings and a breakdown table with counts and percentages"/>
...
{: .note }
> Portal names shown in the statistics table correspond to the portal configurations set up under **Schedule > Portals**. See the [Portals documentation]({{ site.baseurl }}{% link _schedule/portals.md %}) for setup instructions.
...
<img src="{{ site.baseurl }}/assets/images/schedule/reporting/reporting-bar-chart.png" width="700" alt="Stacked bar chart showing weekly meeting distribution by booking source with interactive legend"/>
...
When a meeting is booked through a third-party portal, Schedule records both the **Portal ID** and the **Portal Name**. This allows the reporting dashboard to distinguish between different portal integrations and display them separately in the summary table and bar chart.
