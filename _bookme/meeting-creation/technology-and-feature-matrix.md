...
|---|---|---|---|---|
| **Next wave** | | | | |
| **[UWC]({{ site.baseurl }}/bookme/meeting-creation/#roadmap-2026)** (roadmap 2026) | Customer, employee, and (roadmap) partner | **Completely open**, configuration-defined | Configuration-defined | Playbooks + Entity Patterns |
| **[Playbook portals]({{ site.baseurl }}/bookme/meeting-creation/playbooks/)** (2025) | Customer: self-service on a portal | **Completely open**, configuration-defined (standard: `Event`, meeting detail, relations) | Configuration-defined | Playbook editor + Entity Patterns |
| **[Internal meetings]({{ site.baseurl }}/bookme/meeting-creation/internal-meetings/)** (embeddable, 2025) | Employee: advisor books from the embeddable widget | `Event`, meeting detail, advisor relations | Existing Account (linked) | Entity Definitions + Patterns (Admin → Entities) |
| **Stable** | | | | |
| **[CRM Configuration portals]({{ site.baseurl }}/bookme/meeting-creation/crm-configuration/)** (2024) | Customer: on an older portal | `Event`, meeting detail, `Lead`, `EventRelation` | Lead (fixed placeholder) | Field map only; record set is fixed |
| **[Salesforce package]({{ site.baseurl }}/bookme/meeting-creation/salesforce-package/): customer flow** (2022) | Customer: public / Experience Cloud | `Event`, meeting detail, meeting contact, `Opportunity`, `EventRelation` | Opportunity (default) | Field mappings + Apex hooks |
| **[Salesforce package]({{ site.baseurl }}/bookme/meeting-creation/salesforce-package/): employee flow** (2022) | Employee: advisor on a record page (can also book for the customer) | Same set, or reuse an existing record | Account, Opportunity, or Lead (hardcoded) | Field mappings + Apex hooks; advisor UI options |
...
- [UWC (Roadmap 2026)]({{ site.baseurl }}/bookme/meeting-creation/#roadmap-2026) (Next wave)
- [Internal Meetings (Embeddable)]({{ site.baseurl }}/bookme/meeting-creation/internal-meetings/) (Next wave)
- [Playbook Portals]({{ site.baseurl }}/bookme/meeting-creation/playbooks/) (Next wave)
- [Platform-Hosted Booking]({{ site.baseurl }}/bookme/meeting-creation/platform-booking/)
- [Salesforce Package (AppExchange)]({{ site.baseurl }}/bookme/meeting-creation/salesforce-package/) (Stable)
