...
- **Microphone permissions guide** — Step-by-step troubleshooting guide (with screenshots) for enabling microphone access in Chrome and Edge. See [Microphone Permissions]({{ site.baseurl }}/meet/microphone-permissions/).
