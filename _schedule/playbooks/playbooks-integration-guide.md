...
nav_order: 13
redirect_from:
  - /bookme/playbooks/playbooks-integration-guide/
---
...
The Relation Builder shows which input fields the selected capability expects. Map your source data to these fields using the standard [field mapping workflow]({{ site.baseurl }}/schedule/playbooks/playbooks-user-guide/#step-7-map-fields-between-blocks).
...
Entity Pattern blocks provide CRM access through a configured **[entity pattern]({{ site.baseurl }}/schedule/entities-and-entity-patterns/)** — a reusable operation blueprint set up under **Admin > Entities**. Each pattern composes one or more entity definitions into a single operation, with field mappings that abstract away CRM-specific details. The same playbook works regardless of which CRM is connected.

For a full explanation of the entity model, see [Entities and Entity Patterns]({{ site.baseurl }}/schedule/entities-and-entity-patterns/).
...
The Relation Builder shows which variables the selected template expects. Map your source data to these variables using standard [field mappings]({{ site.baseurl }}/schedule/playbooks/playbooks-user-guide/#step-7-map-fields-between-blocks).

{: .hint }
Templates are managed separately from playbooks. If you need a new template, create it under **Admin > Templates** first, then select it in your playbook's Template block. For a full guide on creating and managing templates, see [Templates]({{ site.baseurl }}/schedule/templates/).
...
[Schedule portals]({{ site.baseurl }}/schedule/portals/) generate events that trigger playbook execution. Two trigger types respond to portal events:
...
For details on how CRM data access is secured, see [CRM Integration Security]({{ site.baseurl }}/schedule/onboarding/crm-integration-security/).

---

## Related Documentation

- [Introduction to Playbooks]({{ site.baseurl }}/schedule/playbooks/introduction-to-playbooks/) — concepts, block types, and how playbooks work
- [Playbooks User Guide]({{ site.baseurl }}/schedule/playbooks/playbooks-user-guide/) — step-by-step instructions for the visual editor
- [Portal Configuration]({{ site.baseurl }}/schedule/portals/) — setting up the portals that trigger playbooks
- [Templates]({{ site.baseurl }}/schedule/templates/) — creating and managing text formatting templates
- [Entities and Entity Patterns]({{ site.baseurl }}/schedule/entities-and-entity-patterns/) — the entity model, pattern parts, and how CRM abstraction works
- [CRM Integration Security]({{ site.baseurl }}/schedule/onboarding/crm-integration-security/) — security model for CRM data access
