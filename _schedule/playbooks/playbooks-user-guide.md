...
nav_order: 12
redirect_from:
  - /bookme/playbooks/playbooks-user-guide/
---
...
![Playbooks list]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/playbooks-list.png)
...
{: .note }
Some playbooks may show a green **"Managed"** badge (with a checkmark icon). Those are maintained by &Money — you can view and use them, but Edit / Delete are unavailable. If you need to customize a managed playbook, use the **Fork** action to create your own editable copy. See [Managed Playbooks]({{ site.baseurl }}/schedule/playbooks/managed-playbooks/) for the full details.
...
![Visual editor overview]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/editor-canvas-overview.png)
...
![New playbook with trigger and suggestions]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/editor-new-playbook.png)
...
![Trigger block expanded]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/editor-trigger-expanded.png)
...
![A new Untyped block appears after clicking Add block]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/guide-add-block.png)
...
![Block type dropdown showing all available types]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/guide-select-type.png)
...
![A dashed edge appears between connected blocks]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/guide-connection-edge.png)
...
![Block showing inputs with a mapping row]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/guide-mapping-row.png)
...
![Relation Builder modal for selecting a field path]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/guide-relation-builder.png)
...
![Edge labels showing mapping counts between blocks]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/guide-mapping-counts.png)
...
![Validation results]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/editor-validation.png)
...
When a customer books a meeting through a Schedule portal:
...
![Complex playbook]({{ site.baseurl }}/assets/images/schedule/playbooks/editor/editor-complex-playbook.png)
...
- [Introduction to Playbooks]({{ site.baseurl }}/schedule/playbooks/introduction-to-playbooks/) — concepts, block types, and transformation reference
- [Playbooks Integrations]({{ site.baseurl }}/schedule/playbooks/playbooks-integration-guide/) — AI, CRM, and template integration details
- [Portal Configuration]({{ site.baseurl }}/schedule/portals/) — setting up the portals that trigger playbooks
