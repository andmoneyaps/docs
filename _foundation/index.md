...
Technical foundations that every Engage platform product — Schedule, Meet, Present, Insights — sits on. The work in this section is done once per tenant; the resulting configuration is reused across products without reconfiguration.
...
If you are touching anything in this section, the change typically affects every product on the platform. Product-specific configuration (Schedule portals, Present templates, Meet meeting settings) belongs in the product collections, not here.
