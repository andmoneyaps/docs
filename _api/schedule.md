...
The Schedule API provides comprehensive access to meeting booking and scheduling functionality. This documentation covers API Version 3.0.0 (latest) and includes V2 features. For migration from V2 to V3, see the [V2 to V3 Migration Guide]({{ site.baseurl }}/api/migration-guide-v3).
...
Note that the fields related to portal meetings "portalId, customFields and externalAttendees" are only used during portal meeting bookings and are not used during booking of a normal Schedule meeting.
