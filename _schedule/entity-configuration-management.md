...
parent: Schedule
redirect_from:
  - /bookme/entity-configuration-management/
---
...
For a conceptual overview of entity definitions and patterns, see [Entities and Entity Patterns]({{ site.baseurl }}/schedule/entities-and-entity-patterns/).
...
├── patterns/
│   ├── internal-schedule-meeting.json
...
- [Internal Meetings Deployment Guide]({{ site.baseurl }}/schedule/internal-meetings-deployment-guide/) — entity configuration specific to internal meetings
