...
| [Present on Dynamics 365 and SharePoint]({{ site.baseurl }}/foundation/dynamics-sharepoint-onboarding/) | Step-by-step configuration for a tenant on Microsoft Dynamics 365 with presentations stored in SharePoint — admin consent, the Dataverse authorisation and application user, the SharePoint site, and the appointment-form launch point. | Azure / Entra admin + Dynamics 365 admin |
...
3. Once Foundation surfaces are configured, move on to product-specific onboarding:
   ...
   - [Present on Dynamics 365 and SharePoint]({{ site.baseurl }}/foundation/dynamics-sharepoint-onboarding/) — if your CRM is Dynamics 365 rather than Salesforce
