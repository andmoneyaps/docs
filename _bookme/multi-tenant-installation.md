---
layout: default
title: Multi-Tenant Installation Guide
nav_order: 4
parent: BookMe
---
...
This guide provides detailed instructions for ISVs and partners deploying BookMe across multiple customer tenants.
...
3. **Security Group Object ID**: 
   - Customer provides Object ID of their BookMe users group
...
2. Find the newly created applications:
   - BookMe SCIM Provisioning
   - BookMe Calendar Integration
...
2. Select **BookMe SCIM Provisioning**
