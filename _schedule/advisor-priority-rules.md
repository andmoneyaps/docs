...
1. Navigate to **Schedule** → **Meeting Setup** → **Operating Level** in the Management UI
...
2. Assign labels to your service groups in **Schedule** → **Service Groups**
   - Assign "prio-1" to your high-priority service groups
   - Assign "prio-2" to your standard service groups

3. Configure priority rules in **Schedule** → **Meeting Setup** → **Operating Level**
