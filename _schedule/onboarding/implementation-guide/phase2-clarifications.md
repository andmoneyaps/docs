...
redirect_from:
  - /bookme/onboarding/implementation-guide/phase2-clarifications/
---
...
2. Installation of the &schedule project package.
...
![Auth provider]({{ site.baseurl }}/assets/images/schedule/onboarding/implementation-guide/auth-prov.png)
...
![Booking platform client credential]({{ site.baseurl }}/assets/images/schedule/onboarding/implementation-guide/bp-client-cred.png)
...
![Named credentials]({{ site.baseurl }}/assets/images/schedule/onboarding/implementation-guide/named-creds.png)
