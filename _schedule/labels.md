...
|-------------|---------------------------|
| **Service Groups** | Schedule → Service Groups |
| **Competence Groups** | Schedule → Competence Groups |
| **Portals** | Schedule → Portals |
...
1. Go to **Schedule** → **Service Groups**
...
1. Go to **Schedule** → **Competence Groups**
