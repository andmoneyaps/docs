...
nav_order: 14
redirect_from:
  - /bookme/playbooks/managed-playbooks/
---
...
![Playbook list with Managed badges]({{ site.baseurl }}/assets/images/schedule/playbooks/managed/playbook-list-managed-badges.png)
...
2. The Fork Playbook dialog opens, showing the playbook name and the source package + version:
   ...
   ![Fork Playbook dialog]({{ site.baseurl }}/assets/images/schedule/playbooks/managed/fork-modal.png)
...
- [Playbooks User Guide]({{ site.baseurl }}/schedule/playbooks/playbooks-user-guide/) — building and editing playbooks
- [Introduction to Playbooks]({{ site.baseurl }}/schedule/playbooks/introduction-to-playbooks/) — concepts and blocks
