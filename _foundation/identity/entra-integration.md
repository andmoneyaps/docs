...
For detailed instructions on assigning users and groups to app roles, see the [App Registration Installation]({{ site.baseurl }}/foundation/identity/app-registration-installation/#role-assignment-for-the-management-ui) guide.
