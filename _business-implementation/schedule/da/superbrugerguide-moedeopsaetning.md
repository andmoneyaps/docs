...
{: .note }
> **Vis som:** Vælg **ledig**, når medarbejderen skal kunne se tiden i sin kalender, men bufferen ikke skal blokere. **Ledig** fjerner kun den pågældende buffers blokering — de øvrige **kundevendte** regler (tid mellem møder, max. timer pr. dag m.m.) gælder stadig, og **lukkedage** gælder alle flows. **Foreløbig** ser blødere ud i kalenderen, men blokerer præcis som **optaget**. Buffere uden egen indstilling tæller som **optaget**.
