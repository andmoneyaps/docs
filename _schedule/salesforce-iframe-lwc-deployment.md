...
parent: Schedule
redirect_from:
  - /bookme/salesforce-iframe-lwc-deployment/
---
...
The &money EngageMe iframe Lightning Web Component (LWC) is a powerful integration tool that embeds Schedule's meeting booking functionality directly within Salesforce Lightning pages. For a complete overview of embeddable components and their capabilities, see the [Embeddable UI Documentation]({{ site.baseurl }}/embeddable-ui/).
...
The component acts as a seamless bridge between Salesforce CRM data and Schedule's scheduling platform, allowing organizations to leverage their existing customer data while providing advanced booking capabilities.

## Overview

The Schedule Management UI provides a streamlined deployment feature that allows administrators to automatically push this iframe Lightning Web Component directly to their connected Salesforce organization. This eliminates the need for manual deployment through Salesforce CLI or other developer tools.
...
2. **Established Salesforce org connection**: The connection between Schedule and Salesforce must be provisioned and tested successfully
...
Before deploying the component, you must establish a secure connection between Schedule and your Salesforce organization. Follow the comprehensive instructions in the [Salesforce Connection Setup]({{ site.baseurl }}/schedule/onboarding/salesforce-connection-setup/) guide which covers:
...
- Supports all configuration options documented in the [Iframe LWC Configuration guide]({{ site.baseurl }}/schedule/salesforce-iframe-lwc/)
...
- [Salesforce Connection Setup]({{ site.baseurl }}/schedule/onboarding/salesforce-connection-setup/) - Detailed guide for establishing the Schedule-Salesforce connection
- [Salesforce Iframe LWC Configuration]({{ site.baseurl }}/schedule/salesforce-iframe-lwc/) - Configuration options for the deployed iframe component
- [Salesforce Schedule Integration Setup]({{ site.baseurl }}/schedule/onboarding/salesforce-setup/) - Complete Salesforce package installation and metadata configuration
- [CRM Integration Security]({{ site.baseurl }}/schedule/onboarding/crm-integration-security/) - Security architecture and considerations
