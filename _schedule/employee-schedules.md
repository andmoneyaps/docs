...
parent: Schedule
redirect_from:
  - /bookme/employee-schedules/
---

# Employee Schedules

Employee schedules control when each employee is available for meeting bookings. Schedules are managed in the Management UI under **Schedule → Advisors → Manage Availability**.
...
- [Locations]({{ site.baseurl }}/schedule/onboarding/implementation-guide/phase3-adaptation/#location-matching-between-entra-and-salesforce) must be configured before assigning per-weekday locations
...
| **MaxMeetingTimePerDay** | Optional override for the bank-wide `MaxMeetingTimePerDay` setting. When set, this limit applies instead of the bank default. Note: this limit is not enforced for [internal meetings]({{ site.baseurl }}/schedule/internal-meetings-deployment-guide/). |
...
| **Location** | The employee's location for this day. This determines which customers and rooms the employee is matched with — the location string must exactly match the [location configuration]({{ site.baseurl }}/schedule/onboarding/implementation-guide/phase3-adaptation/#location-matching-between-entra-and-salesforce) in the Management UI and SCIM. |
...
For details, see [Service & Competence Groups — Daily Meeting Time Limits]({{ site.baseurl }}/schedule/service-competence-groups/#daily-meeting-time-limits).
...
- [Service & Competence Groups]({{ site.baseurl }}/schedule/service-competence-groups/) — grouping employees and configuring service levels
- [Internal Meetings Deployment Guide]({{ site.baseurl }}/schedule/internal-meetings-deployment-guide/) — schedule requirements specific to internal meetings
- [Location Matching]({{ site.baseurl }}/schedule/onboarding/implementation-guide/phase3-adaptation/#location-matching-between-entra-and-salesforce) — how location strings are matched
