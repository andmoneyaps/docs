...
nav_order: 3
redirect_from:
  - /bookme/meeting-creation/salesforce-package/
---
...
The package's configuration is Salesforce-native and lives entirely in your org. For the day-to-day admin view, see [Entity Configuration Management]({{ site.baseurl }}/schedule/entity-configuration-management/); this is a summary of the **options available to you**.
...
- [Entity Configuration Management]({{ site.baseurl }}/schedule/entity-configuration-management/) (admin view of configuration)
- [Salesforce Iframe LWC Configuration]({{ site.baseurl }}/schedule/salesforce-iframe-lwc/) (embedding the flows)
- [Customer Meeting Booking]({{ site.baseurl }}/schedule/customer-meeting-booking/) (the end-user booking experience)
