...
nav_order: 7.4
has_children: true
permalink: /schedule/meeting-creation/
redirect_from:
  - /bookme/meeting-creation/
---
...
|---|---|---|
| [**Internal Meetings (Embeddable)**]({{ site.baseurl }}/schedule/meeting-creation/internal-meetings/) | Advisor-to-advisor meetings booked from the embeddable widget on a record | Entity Patterns |
| [**Playbook Portals**]({{ site.baseurl }}/schedule/meeting-creation/playbooks/) | Customer self-service booking on a portal | A visual Playbook, over entity patterns |
...
The implementations available today are **platform-hosted**: booking happens in the &money platform, which creates the records in your CRM on your behalf (Salesforce or Dynamics 365). See [Platform-Hosted Booking]({{ site.baseurl }}/schedule/meeting-creation/platform-booking/) for the behaviour they share.
...
|---|---|---|
| [**Salesforce Package (AppExchange)**]({{ site.baseurl }}/schedule/meeting-creation/salesforce-package/) | A managed package installed in your org; creates records **in-org** via Apex | Custom-metadata field mappings + Apex hooks |
| [**CRM Configuration Portals**]({{ site.baseurl }}/schedule/meeting-creation/crm-configuration/) | Older portals that create a fixed, Lead-based record set | A simple per-portal field map |
...
|---|---|
| **Next:** advisor internal meetings | [Internal Meetings (Embeddable)]({{ site.baseurl }}/schedule/meeting-creation/internal-meetings/) |
| **Next:** customer self-service portals | [Playbook Portals]({{ site.baseurl }}/schedule/meeting-creation/playbooks/) |
| **Next:** the 2026 web platform | [Roadmap 2026: UWC](#roadmap-2026) |
| What the platform-hosted implementations share | [Platform-Hosted Booking]({{ site.baseurl }}/schedule/meeting-creation/platform-booking/) |
| **Stable:** the in-org AppExchange package | [Salesforce Package (AppExchange)]({{ site.baseurl }}/schedule/meeting-creation/salesforce-package/) |
| **Stable:** the older Leads-only portals | [CRM Configuration Portals]({{ site.baseurl }}/schedule/meeting-creation/crm-configuration/) |
| A side-by-side comparison and where each field value comes from | [Comparison Matrix]({{ site.baseurl }}/schedule/meeting-creation/technology-and-feature-matrix/) |
